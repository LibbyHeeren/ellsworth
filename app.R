...
ui <- fluidPage(
  ...
  tags$div(
    ...
    HTML(markdown::markdownToHTML(text = "This app was created by [Libby Heeren](www.libbyheeren.com). It's a festival of probability and color inspired by the Spectrum Colors Arranged by Chance series of artwork by [Ellsworth Kelly](https://ellsworthkelly.org/) and the fabulous Stacey, aka [The Crooked Hem](https://thecrookedhem.net/), who created [a Kelly-inspired quilt](https://thecrookedhem.substack.com/p/the-quilterly-paintings-of-ellsworth) and [got my wheels turning](https://thecrookedhem.substack.com/p/the-ellsworth-kelly-quilt-part-2). <br> <br>If you'd like to make your own quilt, you can generate one below and download a quilt-planning PDF. But, beware - it's random! If you see a pattern you like, save it! Want to see the code I wrote for this app? Visit [my GitHub repo](https://github.com/LibbyHeeren/ellsworth), and you can go to [my blog](https://libbyheeren.com/blog.html#category=Shiny) to see my development notes. <br> <br> ❤ Libby")),
